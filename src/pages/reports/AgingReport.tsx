...
export default function AgingReport() {
  ...
  const { data, isLoading, refetch } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Fetch invoices with student info and payment allocations
      let query = supabase
      ...
      invoices?.forEach((invoice) => {
        ...
        // Update bucket based on max overdue
  ...
  return (
    <DashboardLayout title="Aging Analysis Report" subtitle="Outstanding balances by age">
